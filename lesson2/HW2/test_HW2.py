...
def test_auth_negative(browser, fake_username, fake_password):
    browser.get(main_url)
    browser.find_element(By.ID, username_field).send_keys(fake_username)
    browser.find_element(By.ID, password_field).send_keys(fake_password)
    browser.find_element(By.ID, login_button).click()
...
def test_order_positive(browser, fake_firstname, fake_lastname, fake_zipcode):
    ...
    browser.find_element(By.ID, order_firstname_field).send_keys(fake_firstname)
    browser.find_element(By.ID, order_lastname_field).send_keys(fake_lastname)
    browser.find_element(By.ID, order_zipcode_field).send_keys(fake_zipcode)
